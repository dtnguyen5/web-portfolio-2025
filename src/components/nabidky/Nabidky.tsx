...
const Nabidky = () => (
  <div className="flex flex-col items-center justify-center gap-8 md:gap-20 md:flex-row">
    {nabidky.cards.map((card) => (
      <div
        key={card.title}
        className="flex flex-col items-center justify-center gap-9 md:gap-7 h-[35vh] w-[90vw] sm:h-[35vh] sm:w-[70vw] md:h-[35vh] md:w-[30vw] rounded-[10%] nabidky-card pt-8 pl-4 sm:pt-8 sm:pl-4 md:pt-0 md:pl-0"
      >
